...
public class KothLoseCapEvent extends Event implements Cancellable {
	...
	public KothLoseCapEvent(KOTHArena koth, Player player, String teamName, World world, int x, int y, int z, int captureLength) {
		this.koth = koth;
		this.world = world;
		this.x = x;
		this.y = y;
